    ...
    $qry = '{
            "query": {
                "filtered": {
                    "query": {
                        "query_string": {
                            "query": "nagios_notifyname:\"'.$pagername.'\" AND NOT (nagios_state:\"ACKNOWLEDGEMENT*\" OR nagios_state:\"UP\" OR nagios_state:\"OK\") AND NOT (nagios_service:\"SMS Check\" OR nagios_comment:\"Test SMS from Cloud Control\")"
                        }
                    },
                    "filter": {
                        "bool": {
